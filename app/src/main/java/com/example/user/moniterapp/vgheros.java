...
public class vgheros extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ar.add(new customArrayadapter("Kensei", R.drawable.vg));
        ...
        ListView view = findViewById(R.id.builds);
        ListView view1 = findViewById(R.id.counters);
