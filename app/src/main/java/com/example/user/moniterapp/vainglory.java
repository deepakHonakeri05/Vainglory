...
public class vainglory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ar.add(new Character(19,"Kinetic", R.drawable.kinetic));
        ar.add(new Character(20,"Koshka", R.drawable.koshka));
        ar.add(new Character(21,"Krul", R.drawable.krul));
        ar.add(new Character(22,"Lance", R.drawable.lance));
        ar.add(new Character(23,"Lorelai", R.drawable.lorelai));
        ar.add(new Character(24,"Lyra", R.drawable.lyra));
        ar.add(new Character(25,"Malene", R.drawable.malene));
        ar.add(new Character(26,"Ozo", R.drawable.ozo));
        ar.add(new Character(27,"Petal", R.drawable.petal));
        ar.add(new Character(28,"Phinn", R.drawable.phinn));
        ar.add(new Character(29,"Reim", R.drawable.reim));
        ar.add(new Character(30,"Reza", R.drawable.reza));
        ar.add(new Character(31,"Ringo", R.drawable.ringo));
        ar.add(new Character(32,"Rona", R.drawable.rona));
        ar.add(new Character(33,"Samuel", R.drawable.samuel));
        ar.add(new Character(34,"Saw", R.drawable.saw));
        ar.add(new Character(35,"Skaarf", R.drawable.skaarf));
        ar.add(new Character(36,"Skye", R.drawable.skye));
        ar.add(new Character(37,"Taka", R.drawable.taka));
        ar.add(new Character(38,"Tony", R.drawable.tony));
        ar.add(new Character(39,"Varya", R.drawable.varya));
        ar.add(new Character(40,"Vox", R.drawable.vox));
